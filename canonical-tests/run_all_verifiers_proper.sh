#!/bin/bash
# COMPREHENSIVE test with PROPER metamath.exe wrapper

OUTPUT_FILE="test_results_proper_$(date +%Y%m%d_%H%M%S).txt"

exec > "$OUTPUT_FILE" 2>&1

echo "========================================================================"
echo "COMPREHENSIVE METAMATH VERIFIER TEST - PROPERLY CONFIGURED"
echo "========================================================================"
echo "Date: $(date)"
echo ""
...
# Verifiers
METAMATH_WRAPPER="./mmverify_wrapper.sh"
...
for test in $MAIN_TESTS; do
    ...
    echo -n "  metamath.exe:        "
    test_one "$METAMATH_WRAPPER" "$test"
